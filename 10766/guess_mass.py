...
# config_path = os.path.join(root_dir, f"{idx_name}/obj{idx_name}_s2_com.lyric")
config_path = "/home/zhongyi/work/GALFITS/DATA/ZHIJIANG/P6/10766/results/nosed/s2_com_nosed/obj10766_s2_com.lyric"
# workplace = os.path.join(root_dir, f"{idx_name}/results")
workplace = "/home/zhongyi/work/GALFITS/DATA/ZHIJIANG/P6/10766/results/nosed/s2_com_nosed"
...
model_idx = 1 ## model index of profiles, like galaxy_1, galaxy_2, agn, in which there may be multi components, like disk, bulge etc.
model_name = "galaxy_2" ## the name of this {model idx} model.
...
for model_subcom_name in Myfitter.model_list[model_idx].subnames:
    ...
    for idx_band in range(len(band_lists)):
        ...
        print("the mag read from gssummary is ", mag_best_2, "flux(muJy) is ", flux_mJy)
        fluxs.append(flux_mJy)
...
os.makedirs(mass_guess_dir, exist_ok=True)
