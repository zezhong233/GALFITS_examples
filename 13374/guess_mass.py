...
root_dir = "/home/zhongyi/work/GALFITS/DATA/ZHIJIANG/P4" ## path change 

# config_path = os.path.join(root_dir, f"{idx_name}/obj{idx_name}_s2_com.lyric")
config_path = "/home/zhongyi/work/GALFITS/DATA/ZHIJIANG/P4/13374/results/nosed/s2/obj13374_s2.lyric"
# workplace = os.path.join(root_dir, f"{idx_name}/results")
workplace = "/home/zhongyi/work/GALFITS/DATA/ZHIJIANG/P4/13374/results/nosed/s2"
...
genomckdata(cat_file = cat_file, galid = idx_name, mockpath = mockpath, z_fit = z_fix)
